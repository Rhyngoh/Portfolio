      ...
      <div className="content-grid">
        ...
        <div className="about-wrapper">
          <div className="about-content" style={{ color: textPrimary }}>
            ...
            <p>
              I am a <span className="highlight">Fullstack Engineer</span> with experience building applications using React/Next, Express, Node.js, and .NET. I have experience with various technologies such as AWS, Firebase, Google Maps API, Solidity.
            </p>
            <p>
