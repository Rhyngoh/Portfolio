...
export default [
  ...
  },
  {
    ...
    render: (
      <div className='portfolio-item'>
        <div className='portfolio-item__title'>
          Giddy: Full Stack Dev
        </div>
        <div className='portfolio-item__desc'>
          <div>Experience: Mar 2023 - Present</div>
          <div>Giddy is the world's leading sexual health platform. At Giddy, Ryan created landing pages and helped migrate website to NextJS/TailwindCSS.</div>
        </div>
        <div className='portfolio-item__icon'>
          <i className="fab fa-react"></i>
          <i className="fab fa-css3"></i>
        ...
        <div className='portfolio-item__links'>
          <a target="_blank" rel="noopener noreferrer" href="https://getmegiddy.com/">Website</a>
        </div>
      </div>
    )
  },
